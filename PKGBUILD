...
package() {
    ...
    install -Dm644 "src/systemd/bk.service" "$pkgdir/usr/lib/systemd/system/bk.service"
    install -Dm644 "src/systemd/bk.timer" "$pkgdir/usr/lib/systemd/system/bk.timer"
    install -Dm644 "config.toml" "$pkgdir/etc/bk.toml"
}
